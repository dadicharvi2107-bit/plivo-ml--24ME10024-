"""Trainer with Cosine Learning Rate Decay and linear warmup.

    python train_cosine.py --data ../data/train_corpus.txt --steps 2000 --out ckpt.pt
"""
import argparse
import time
import math
...
def main():
    ...
    ap.add_argument("--lr", type=float, default=3e-4) # keep standard baseline LR
